...
Room* Room3_BuildMainHallway()
{
	...
	Room_AddRoomExit(room, "storage room", 2);
...
Room* Room8_Build_CaptainsRoom()
{
	...
	/* Create the room
	include an initial room description */
	room = Room_Create("You enter a larger more luxurious room. In it there is a very large bed and a desk. \n On the desk theres a nametag reading 'Capt. Capton Ryan' next to it lays a keycard. \n");
